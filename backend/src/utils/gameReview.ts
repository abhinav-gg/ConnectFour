...
import { getConnect4Solver, IConnect4Solver } from "@shared/WASM/con4Solver.type";
...
export class GameReview extends SelfAnalysis {
    ...
    classifyMoves (): Record<string, MoveClassification> {
        ...
        const Classify = (pos: string, analysis: number[]): MoveClassification => {
        ...
        for (const stringToAnalyse of this.gameState.cumulativeMoves()) {
            ...
            const classification = Classify(stringToAnalyse, analysis);
