...
export default function AboutUs() {
  return (
    <div className="min-h-screen bg-black flex w-full">
      <Dashboard />
      <div className="w-full flex flex-col items-center p-6 bg-gray-800 shadow-lg rounded-lg">
        <h1 className="text-4xl font-bold text-center mb-12 text-blue-300">About Connect Four</h1>

        <div className="gap-12 mb-12 items-center">
          <div className="flex flex-col items-center">
            <h2 className="text-2xl font-semibold mb-4 text-center text-blue-400">The Game</h2>
            ...
            <h3 className="text-xl font-semibold mb-2 text-center text-blue-400">Mathematical Solution</h3>
        ...
        <div className="flex flex-col items-center mb-12">
          <h2 className="text-2xl font-semibold mb-4 text-center text-blue-400">Try it out!</h2>
          <SinglePlayerGameboard ref={new GameState()} />
        </div>

        <div className="flex flex-col gap-y-8 mb-12 w-full sm:w-2/3">
          <h2 className="text-2xl font-semibold text-blue-300">About The Team</h2>
          <div className='flex flex-row flex-wrap gap-4 items-center'>
            <Image src="/user.svg" alt="Abhinav" className="rounded-full w-32 h-32 hover:drop-shadow-lg hover:scale-105 transition-all duration-200" width={128} height={128} />
            <div>
              <h3 className="text-xl font-medium text-blue-400">Abhinav <span className='text-gray-300 font-normal'>• Founder</span></h3>
          ...
          <div className='flex flex-row flex-wrap gap-4 items-center'>
            ...
            <div>
              <h3 className="text-xl font-medium text-blue-400">Ivan <span className='text-gray-300 font-normal'>• Co-Founder</span></h3>
              <p className="text-white">
          ...
          <div className='flex flex-row flex-wrap gap-4 items-center'>
            ...
            <div>
              <h3 className="text-xl font-medium text-blue-400">Avery <span className='text-gray-300 font-normal'>• Co-Founder</span></h3>
              <p className="text-white">
