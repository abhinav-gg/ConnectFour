    ...
    <div className="min-h-screen bg-gray-100 flex w-full">
      ...
      <div className="w-full flex flex-col items-center p-4">
        ...
        <div className="flex flex-col gap-y-8 mb-12 w-full sm:w-2/3">
          <h2 className="text-2xl font-semibold">About The Team</h2>
          <div className='flex flex-row flex-wrap gap-2 items-center'>
            ...
            <div>
              <h3 className="text-xl font-medium">Abhinav <span className='text-gray-400 font-normal'>• Founder</span></h3>
              <p>
          ...
          <div className='flex flex-row flex-wrap gap-2 items-center'>
            ...
            <div>
              <h3 className="text-xl font-medium">Avery <span className='text-gray-400 font-normal'>• Co-Founder</span></h3>
              <p>
