...
export default function Terms() {
  return (
    <div>
      ...
      <p><strong>Last updated</strong> <strong>January 24, 2025</strong></p>
      <p> </p>
      <p> </p>
      <p><strong>AGREEMENT TO OUR LEGAL TERMS</strong></p>
      <p>We are Con4 ('<strong>Company</strong>', '<strong>we</strong>', '<strong>us</strong>', or
        '<strong>our</strong>').</p>
      <p> </p>
      <p>We operate the website con4.uk (the '<strong>Site</strong>'), as well as any other related
      ...
      <p> </p>
      <p>The Con4 platform (accessible at con4.uk) is an independent online platform inspired by the classic game Four
        in a Row. Users can play matches against other human players or an AI opponent and analyse their gameplay
        through features like move categorisation and strength evaluation. The platform is designed for personal
        and non-commercial use and aims to provide an engaging and educational experience for all users.
      </p>
      <p> </p>
      <p>You can contact us by email at support@con4.uk.</p>
      <p> </p>
      <p>These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an
        entity ('<strong>you</strong>'), and Con4, concerning your access to and use of the Services. You agree that by
        accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT
        AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST
      ...
      <p>We will provide you with prior notice of any scheduled changes to the Services you are using. The modified Legal
        Terms will become effective upon posting or notifying you, as stated in the email message. By
        continuing to use the Services after the effective date of any changes, you agree to be bound by the modified terms.
      </p>
      <p> </p>
      <p>The Services are intended for users who are at least 18 years old. Persons under the age of 18 are not permitted to
        use or register for the Services.</p>
      <p> </p>
      <p>We recommend that you print a copy of these Legal Terms for your records.</p>
      <p> </p>
      <p><strong>TABLE OF CONTENTS</strong></p>
      <ol>
        <li><a className="inline-block text-blue-500 font-bold underline" href="#services"> OUR SERVICES</a></li>
        <li><a className="inline-block text-blue-500 font-bold underline" href="#ip"> INTELLECTUAL PROPERTY RIGHTS</a></li>
        <li><a className="inline-block text-blue-500 font-bold underline" href="#userreps"> USER REPRESENTATIONS</a></li>
        <li><a className="inline-block text-blue-500 font-bold underline" href="#userreg"> USER REGISTRATION</a></li>
        <li><a className="inline-block text-blue-500 font-bold underline" href="#prohibited"> PROHIBITED ACTIVITIES</a></li>
        <li><a className="inline-block text-blue-500 font-bold underline" href="#ugc"> USER GENERATED CONTRIBUTIONS</a></li>
        <li><a className="inline-block text-blue-500 font-bold underline" href="#license"> CONTRIBUTION LICENCE</a></li>
        <li><a className="inline-block text-blue-500 font-bold underline" href="#socialmedia"> SOCIAL MEDIA</a></li>
        <li><a className="inline-block text-blue-500 font-bold underline" href="#thirdparty"> THIRD-PARTY WEBSITES AND CONTENT</a></li>
        <li><a className="inline-block text-blue-500 font-bold underline" href="#sitemanage"> SERVICES MANAGEMENT</a></li>
        <li><a className="inline-block text-blue-500 font-bold underline" href="#ppyes"> PRIVACY POLICY</a></li>
        <li><a className="inline-block text-blue-500 font-bold underline" href="#copyrightno"> COPYRIGHT INFRINGEMENTS</a></li>
        <li><a className="inline-block text-blue-500 font-bold underline" href="#terms"> TERM AND TERMINATION</a></li>
        <li><a className="inline-block text-blue-500 font-bold underline" href="#modifications"> MODIFICATIONS AND INTERRUPTIONS</a></li>
        <li><a className="inline-block text-blue-500 font-bold underline" href="#law"> GOVERNING LAW</a></li>
        <li><a className="inline-block text-blue-500 font-bold underline" href="#disputes"> DISPUTE RESOLUTION</a></li>
        <li><a className="inline-block text-blue-500 font-bold underline" href="#corrections"> CORRECTIONS</a></li>
        <li><a className="inline-block text-blue-500 font-bold underline" href="#disclaimer"> DISCLAIMER</a></li>
        <li><a className="inline-block text-blue-500 font-bold underline" href="#liability"> LIMITATIONS OF LIABILITY</a></li>
        <li><a className="inline-block text-blue-500 font-bold underline" href="#indemnification"> INDEMNIFICATION</a></li>
        <li><a className="inline-block text-blue-500 font-bold underline" href="#userdata"> USER DATA</a></li>
        <li><a className="inline-block text-blue-500 font-bold underline" href="#electronic"> ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</a></li>
        <li><a className="inline-block text-blue-500 font-bold underline" href="#misc"> MISCELLANEOUS</a></li>
        <li><a className="inline-block text-blue-500 font-bold underline" href="#contact"> CONTACT US</a></li>
      </ol>
      <p> </p>
      <ol>
        <li id="services"><strong> OUR SERVICES</strong></li>
      </ol>
      ...
      <p> </p>
      <ol start="2">
        <li id="ip"><strong> INTELLECTUAL PROPERTY RIGHTS</strong></li>
      </ol>
      ...
      <p>Subject to your compliance with these Legal Terms, including the '<a className="inline-block text-blue-500 font-bold underline" href="#prohibited">PROHIBITED
      ...
      <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in
        our Legal Terms, please address your request to: support@con4.uk. If we ever grant you the permission to post,
        ...
        reproducing, or displaying our Content.</p>
      <p> </p>
      ...
      <p>Please review this section and the '<a className="inline-block text-blue-500 font-bold underline" href="#prohibited">PROHIBITED ACTIVITIES</a>' section
        carefully prior to using our Services to understand the (a) rights you give us and (b) obligations you have when you
      ...
      <p> </p>
      <p><strong>When you post Contributions, you grant us a licence (including use of your name, trademarks, and
        ...
        reproduce, distribute, sell, resell, publish, broadcast, retitle, store, publicly perform, publicly display, reformat,
        translate, excerpt (in whole or in part), and exploit your Contributions (including, without limitation, your image,
        ...
        Our use and distribution may occur in any media formats and through any media channels.</p>
      <p> </p>
      <p>This licence includes our use of your name, company name, and franchise name, as applicable, and any of the
      ...
      <p><strong>You are responsible for what you post or upload:</strong> By sending us Submissions and/or posting
        ...
        linking your account through the Services to any of your social networking accounts, you:</p>
      <ul>
        <li>confirm that you have read and agree with our '<a className="inline-block text-blue-500 font-bold underline" href="#prohibited">PROHIBITED
          ACTIVITIES</a>' and will not post, send, publish, upload, or transmit through the Services any
        ...
        <li>warrant that any such Submission and/or Contributions are original to you or that you have the necessary
          rights and licences to submit such Submissions and/or Contributions and that you have full
          authority to grant us the above-mentioned rights in relation to your Submissions and/or Contributions; and</li>
        <li>warrant and represent that your Submissions and/or Contributions do not constitute confidential
          information.</li>
      </ul>
      <p>You are solely responsible for your Submissions and/or Contributions and you expressly agree to reimburse
        us for any and all losses that we may suffer because of your breach of (a) this section, (b) any third party&rsquo;s
        intellectual property rights, or (c) applicable law.</p>
      <p> </p>
      <p><strong>We may remove or edit your Content:</strong> Although we have no obligation to monitor any
        Contributions, we shall have the right to remove or edit any Contributions at any time without notice if in our
        reasonable opinion we consider such Contributions harmful or in breach of these Legal Terms. If we remove or edit any
      ...
      <p>We respect the intellectual property rights of others. If you believe that any material available on or through the
        Services infringes upon any copyright you own or control, please immediately refer to the '<a
          href="#copyrightno">COPYRIGHT INFRINGEMENTS</a>' section below.</p>
      <p> </p>
      <ol start="3">
        <li id="userreps"><strong> USER REPRESENTATIONS</strong></li>
      </ol>
      <p>By using the Services, you represent and warrant that: (1) all registration information you submit will be true,
        ...
        through automated or non-human means, whether through a bot, script or otherwise; (6) you will not use the Services
        for any illegal or unauthorised purpose; and (7) your use of the Services will not violate any applicable
        law or regulation.</p>
      <p> </p>
      ...
      <p> </p>
      <ol start="4">
        <li id="userreg"><strong> USER REGISTRATION</strong></li>
      </ol>
      ...
      <p> </p>
      <ol start="5">
        <li id="prohibited"><strong> PROHIBITED ACTIVITIES</strong></li>
      </ol>
      ...
      <ul>
        ...
        <li>Circumvent, disable, or otherwise interfere with security-related features of the Services, including features
          that prevent or restrict the use or copying of any Content or enforce limitations on the use of the Services and/or
        ...
        <li>Upload or transmit (or attempt to upload or to transmit) viruses, Trojan horses, or other material, including
          ...
          party&rsquo;s uninterrupted use and enjoyment of the Services or modifies, impairs, disrupts, alters, or interferes
        ...
        <li>Upload or transmit (or attempt to upload or to transmit) any material that acts as a passive or active information
          collection or transmission mechanism, including without limitation, clear graphics interchange formats ('gifs'),
          1&times;1 pixels, web bugs, cookies, or other similar devices (sometimes referred to as 'spyware' or 'passive
        ...
        <li>Copy or adapt the Services' software, including but not limited to Flash, PHP, HTML, JavaScript, or other code.
        </li>
        ...
        <li>Except as may be the result of standard search engine or Internet browser usage, use, launch, develop, or
          ...
          reader that accesses the Services, or use or launch any unauthorised script or other software.</li>
        ...
        <li>Use the Services as part of any effort to compete with us or otherwise use the Services and/or the Content for any
          revenue-generating endeavour or commercial enterprise.</li>
        <li>Use the Services to advertise or offer to sell goods and services.</li>
        <li>Sell or otherwise transfer your profile.</li>
        <li>Employ or make use of cheats, exploits, or automation tools to manipulate gameplay or otherwise gain an unfair
          advantage.</li>
        <li>Falsely suggest or imply that you are affiliated with Con4 or representing it in any capacity.</li>
        <li>Attempt to access administrative features, developer tools, or any restricted areas of the site.</li>
        <li>Upload or share any content that is hateful, discriminatory, or otherwise offensive.</li>
        <li>Share personal information on the platform.</li>
        <li>Impersonate any employee, representative, partner, or affiliate of Con4.</li>
        <li>Circumvent game rules or mechanics to disrupt gameplay or manipulate outcomes.</li>
      </ul>
      <p> </p>
      <ol start="6">
        <li id="ugc"><strong> USER GENERATED CONTRIBUTIONS</strong></li>
      </ol>
      <p>The Services may invite you to chat, contribute to, or participate in blogs, message boards, online forums, and other
        ...
        third-party websites. As such, any Contributions you transmit may be treated as non-confidential and non-proprietary.
      ...
      <ul>
        ...
        <li>You have the written consent, release, and/or permission of each and every identifiable individual person in your
          Contributions to use the name or likeness of each and every such identifiable individual person to enable inclusion
          and use of your Contributions in any manner contemplated by the Services and these Legal Terms.</li>
        <li>Your Contributions are not false, inaccurate, or misleading.</li>
        <li>Your Contributions are not unsolicited or unauthorised advertising, promotional materials, pyramid
        ...
        <li>Your Contributions are not used to harass or threaten (in the legal sense of those terms) any other person and to
          promote violence against a specific person or class of people.</li>
      ...
      <p> </p>
      <ol start="7">
        <li id="license"><strong> CONTRIBUTION LICENCE</strong></li>
      </ol>
      <p>By posting your Contributions to any part of the Services or making Contributions accessible to the Services by
        ...
        derivative works of, or incorporate into other works, such Contributions, and grant and authorise
        sublicences of the foregoing. The use and distribution may occur in any media formats and through any media
        channels.</p>
      <p> </p>
      <p>This licence will apply to any form, media, or technology now known or hereafter developed, and includes
        our use of your name, company name, and franchise name, as applicable, and any of the trademarks, service marks, trade
        names, logos, and personal and commercial images you provide. You waive all moral rights in your Contributions, and
        you warrant that moral rights have not otherwise been asserted in your Contributions.</p>
      <p> </p>
      <p>We do not assert any ownership over your Contributions. You retain full ownership of all of your Contributions and
        ...
        any statements or representations in your Contributions provided by you in any area on the Services. You are solely
      ...
      <p>We have the right, in our sole and absolute discretion, (1) to edit, redact, or otherwise change any Contributions;
        (2) to re-categorise any Contributions to place them in more appropriate locations on the Services; and (3)
        to pre-screen or delete any Contributions at any time and for any reason, without notice. We have no obligation to
        monitor your Contributions.</p>
      <p> </p>
      <ol start="8">
        <li id="socialmedia"><strong> SOCIAL MEDIA</strong></li>
      </ol>
      <p>As part of the functionality of the Services, you may link your account with online accounts you have with
        ...
        each Third-Party Account. You represent and warrant that you are entitled to disclose
        your Third-Party Account login information to us and/or grant us access to
        your Third-Party Account, without breach by you of any of the terms and conditions that govern your use of
        the applicable Third-Party Account, and without obligating us to pay any fees or making us subject to any
        ...
        Network Content') so that it is available on and through the Services via your account, including without limitation
        any friend lists and (2) we may submit to and receive from your Third-Party Account additional information
        ...
        a Third-Party Account or associated service becomes unavailable or our access to
        such Third-Party Account is terminated by the third-party service provider, then Social Network Content may
        no longer be available on and through the Services. You will have the ability to disable the connection between your
        account on the Services and your Third-Party Accounts at any time. PLEASE NOTE THAT YOUR RELATIONSHIP WITH
        THE THIRD-PARTY SERVICE PROVIDERS ASSOCIATED WITH YOUR THIRD-PARTY ACCOUNTS IS GOVERNED SOLELY BY YOUR AGREEMENT(S)
        WITH SUCH THIRD-PARTY SERVICE PROVIDERS. We make no effort to review any Social Network Content for any purpose,
        including but not limited to, for accuracy, legality, or non-infringement, and we are not responsible for any Social
        Network Content. You acknowledge and agree that we may access your email address book associated with
        a Third-Party Account and your contacts list stored on your mobile device or tablet computer solely for
        purposes of identifying and informing you of those contacts who have also registered to use the Services. You can
        deactivate the connection between the Services and your Third-Party Account by contacting us using the
        contact information below or through your account settings (if applicable). We will attempt to delete any information
      ...
      <p> </p>
      <ol start="9">
        <li id="thirdparty"><strong> THIRD-PARTY WEBSITES AND CONTENT</strong></li>
      </ol>
      <p>The Services may contain (or you may be sent via the Site) links to other websites ('Third-Party Websites') as
        ...
        Services, including the content, accuracy, offensiveness, opinions, reliability, privacy practices, or other policies
        of or contained in the Third-Party Websites or the Third-Party Content. Inclusion of, linking to,
        or permitting the use or installation of any Third-Party Websites or any Third-Party Content does
        ...
        including privacy and data gathering practices, of any website to which you navigate from the Services or relating to
        any applications you use or install from the Services. Any purchases you make through Third-Party Websites
        will be through other websites and from other companies, and we take no responsibility whatsoever in relation to such
        purchases which are exclusively between you and the applicable third party. You agree and acknowledge that we do not
        endorse the products or services offered on Third-Party Websites and you shall hold us blameless from any
        harm caused by your purchase of such products or services. Additionally, you shall hold us blameless from any losses
        sustained by you or harm caused to you relating to or resulting in any way from any Third-Party Content or
        any contact with Third-Party Websites.</p>
      <p> </p>
      <ol start="10">
        <li id="sitemanage"><strong> SERVICES MANAGEMENT</strong></li>
      </ol>
      <p>We reserve the right, but not the obligation, to: (1) monitor the Services for violations of these Legal Terms; (2)
        ...
        in any way burdensome to our systems; and (5) otherwise manage the Services in a manner designed to protect our rights
        and property and to facilitate the proper functioning of the Services.</p>
      <p> </p>
      <ol start="11">
        <li id="ppyes"><strong> PRIVACY POLICY</strong></li>
      </ol>
      <p>We care about data privacy and security. Please review our Privacy Policy:<strong> </strong><a
        href="https://con4.uk/privacy"><strong>https://con4.uk/privacy</strong></a>. By using the Services, you agree to be
        ...
        States, Germany, Belgium, Netherlands and Ireland. If you access the Services from any other
        region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ
        from applicable laws in the United Kingdom, United
        States, Germany, Belgium, Netherlands and Ireland, then through your continued use of the
        Services, you are transferring your data to the United Kingdom, United
        States, Germany, Belgium, Netherlands and Ireland, and you expressly consent to have your
        data transferred to and processed in the United Kingdom, United
        States, Germany, Belgium, Netherlands and Ireland.</p>
      <p> </p>
      <ol start="12">
        <li id="copyrightno"><strong> COPYRIGHT INFRINGEMENTS</strong></li>
      </ol>
      <p>We respect the intellectual property rights of others. If you believe that any material available on or through the
        ...
        the material addressed in the Notification. Please be advised that pursuant to applicable law you may be held liable
        for damages if you make material misrepresentations in a Notification. Thus, if you are not sure that material located
        on or linked to by the Services infringes your copyright, you should consider first contacting an attorney.</p>
      <p> </p>
      <ol start="13">
        <li id="terms"><strong> TERM AND TERMINATION</strong></li>
      </ol>
      <p>These Legal Terms shall remain in full force and effect while you use the Services. WITHOUT LIMITING ANY OTHER
        PROVISION OF THESE LEGAL TERMS, WE RESERVE THE RIGHT TO, IN OUR SOLE DISCRETION AND WITHOUT NOTICE OR LIABILITY, DENY
        ACCESS TO AND USE OF THE SERVICES (INCLUDING BLOCKING CERTAIN IP ADDRESSES), TO ANY PERSON FOR ANY REASON OR FOR NO
        REASON, INCLUDING WITHOUT LIMITATION FOR BREACH OF ANY REPRESENTATION, WARRANTY, OR COVENANT CONTAINED IN THESE LEGAL
        TERMS OR OF ANY APPLICABLE LAW OR REGULATION. WE MAY TERMINATE YOUR USE OR PARTICIPATION IN THE SERVICES OR
      ...
      <p>If we terminate or suspend your account for any reason, you are prohibited from registering and creating a new
        account under your name, a fake or borrowed name, or the name of any third party, even if you may be acting on behalf
        of the third party. In addition to terminating or suspending your account, we reserve the right to take appropriate
        legal action, including without limitation pursuing civil, criminal, and injunctive redress.</p>
      <p> </p>
      <ol start="14">
        <li id="modifications"><strong> MODIFICATIONS AND INTERRUPTIONS</strong></li>
      </ol>
      ...
      <p> </p>
      <ol start="15">
        <li id="law"><strong> GOVERNING LAW</strong></li>
      </ol>
      <p>These Legal Terms are governed by and interpreted following the laws of England and Wales, and the use of the
        United Nations Convention of Contracts for the International Sales of Goods is expressly excluded. If your habitual
        residence is in the EU, and you are a consumer, you additionally possess the protection provided to you by obligatory
        provisions of the law in your country to residence. Con4 and yourself both agree to submit to the
        non-exclusive jurisdiction of the courts of England and Wales, which means that you may make a claim to defend your
        consumer protection rights in regards to these Legal Terms in England, or in the EU country in which you reside.
      </p>
      <p> </p>
      <ol start="16">
        <li id="disputes"><strong> DISPUTE RESOLUTION</strong></li>
      </ol>
      <p><strong>Informal Negotiations</strong></p>
      <p>To expedite resolution and control the cost of any dispute, controversy, or claim related to these Legal Terms (each
        a 'Dispute' and collectively, the 'Disputes') brought by either you or us (individually, a 'Party' and
      ...
      <p>Any dispute arising from the relationships between the Parties to these Legal Terms shall be determined by one
        ...
        seat of arbitration shall be London, England. The language of the proceedings shall be English.
        Applicable rules of substantive law shall be the law of England.</p>
      <p><strong>Restrictions</strong></p>
      <p>The Parties agree that any arbitration shall be limited to the Dispute between the Parties individually. To the full
        extent permitted by law, (a) no arbitration shall be joined with any other proceeding; (b) there is no right or
        authority for any Dispute to be arbitrated on a class-action basis or to utilise class action procedures;
        and (c) there is no right or authority for any Dispute to be brought in a purported representative capacity on behalf
      ...
      <p>The Parties agree that the following Disputes are not subject to the above provisions concerning informal
        ...
        piracy, invasion of privacy, or unauthorised use; and (c) any claim for injunctive relief. If this provision
      ...
      <p> </p>
      <ol start="17">
        <li id="corrections"><strong> CORRECTIONS</strong></li>
      </ol>
      ...
      <p> </p>
      <ol start="18">
        <li id="disclaimer"><strong> DISCLAIMER</strong></li>
      </ol>
      <p>THE SERVICES ARE PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS. YOU AGREE THAT YOUR USE OF THE SERVICES WILL BE AT YOUR
        ...
        COMPLETENESS OF THE SERVICES' CONTENT OR THE CONTENT OF ANY WEBSITES OR MOBILE APPLICATIONS LINKED TO THE SERVICES AND
        ...
        INFORMATION AND/OR FINANCIAL INFORMATION STORED THEREIN, (4) ANY INTERRUPTION OR CESSATION OF TRANSMISSION TO OR FROM
        THE SERVICES, (5) ANY BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE WHICH MAY BE TRANSMITTED TO OR THROUGH THE SERVICES BY
        ANY THIRD PARTY, AND/OR (6) ANY ERRORS OR OMISSIONS IN ANY CONTENT AND MATERIALS OR FOR ANY LOSS OR DAMAGE OF ANY KIND
        INCURRED AS A RESULT OF THE USE OF ANY CONTENT POSTED, TRANSMITTED, OR OTHERWISE MADE AVAILABLE VIA THE SERVICES. WE
        DO NOT WARRANT, ENDORSE, GUARANTEE, OR ASSUME RESPONSIBILITY FOR ANY PRODUCT OR SERVICE ADVERTISED OR OFFERED BY A
        THIRD PARTY THROUGH THE SERVICES, ANY HYPERLINKED WEBSITE, OR ANY WEBSITE OR MOBILE APPLICATION FEATURED IN ANY BANNER
        ...
        THROUGH ANY MEDIUM OR IN ANY ENVIRONMENT, YOU SHOULD USE YOUR BEST JUDGEMENT AND EXERCISE CAUTION WHERE
        APPROPRIATE.</p>
      <p> </p>
      <ol start="19">
        <li id="liability"><strong> LIMITATIONS OF LIABILITY</strong></li>
      </ol>
      <p>IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY DIRECT,
        ...
        YOU TO US DURING THE SIX (6) MONTH PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING. CERTAIN US STATE LAWS
        AND INTERNATIONAL LAWS DO NOT ALLOW LIMITATIONS ON IMPLIED WARRANTIES OR THE EXCLUSION OR LIMITATION OF CERTAIN
        DAMAGES. IF THESE LAWS APPLY TO YOU, SOME OR ALL OF THE ABOVE DISCLAIMERS OR LIMITATIONS MAY NOT APPLY TO YOU, AND YOU
        MAY HAVE ADDITIONAL RIGHTS.</p>
      <p> </p>
      <ol start="20">
        <li id="indemnification"><strong> INDEMNIFICATION</strong></li>
      </ol>
      <p>You agree to defend, indemnify, and hold us harmless, including our subsidiaries, affiliates, and all of our
        ...
        Services with whom you connected via the Services. Notwithstanding the foregoing, we reserve the right, at your
        expense, to assume the exclusive defence and control of any matter for which you are required to indemnify
        us, and you agree to cooperate, at your expense, with our defence of such claims. We will use reasonable
        efforts to notify you of any such claim, action, or proceeding which is subject to this indemnification upon becoming
        aware of it.</p>
      <p> </p>
      <ol start="21">
        <li id="userdata"><strong> USER DATA</strong></li>
      </ol>
      ...
      <p> </p>
      <ol start="22">
        <li id="electronic"><strong> ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</strong></li>
      </ol>
      <p>Visiting the Services, sending us emails, and completing online forms constitute electronic communications. You
        ...
        VIA THE SERVICES. You hereby waive any rights or requirements under any statutes, regulations, rules, ordinances, or
      ...
      <p>These Legal Terms and any policies or operating rules posted by us on the Services or in respect to the Services
        ...
        the fullest extent permissible by law. We may assign any or all of our rights and obligations to others at any time.
        We shall not be responsible or liable for any loss, damage, delay, or failure to act caused by any cause beyond our
        reasonable control. If any provision or part of a provision of these Legal Terms is determined to be unlawful, void,
        or unenforceable, that provision or part of the provision is deemed severable from these Legal Terms and does not
        affect the validity and enforceability of any remaining provisions. There is no joint venture, partnership, employment
        or agency relationship created between you and us as a result of these Legal Terms or use of the Services. You agree
        that these Legal Terms will not be construed against us by virtue of having drafted them. You hereby waive any and
        all defences you may have based on the electronic form of these Legal Terms and the lack of signing by the
        parties hereto to execute these Legal Terms.</p>
      <p> </p>
      <ol start="24">
        <li id="contact"><strong> CONTACT US</strong></li>
      </ol>
      ...
      <p> </p>
      <p><strong>Con4</strong></p>
      <p><strong>England</strong></p>
      <p><strong>support@con4.uk</strong></p>
    </div>
  );
}