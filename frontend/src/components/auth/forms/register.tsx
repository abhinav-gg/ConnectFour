...
export function RegisterForm() {
  ...
  return (
    <motion.div
      className="space-y-5 select-none" // Reduced space-y from 6 to 5
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      <form className="space-y-5" onSubmit={handleSubmit}>
        ...
        <motion.div
          ...
          initial={{ opacity: 0, x: -20 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.4, delay: 0.6 }} // Adjusted delay
        >
        ...
        <motion.div
          ...
          initial={{ opacity: 0, x: -20 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.4, delay: 0.7 }} // Adjusted delay
        >
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.4, delay: 0.8 }} // Adjusted delay
        >
        ...
        <motion.div
          ...
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 0.4, delay: 0.9 }} // Adjusted delay
        >
        ...
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.4, delay: 1.0 }} // Adjusted delay
        >
          <Button
            type="button"
            variant="outline"
        ...
        <motion.p
          ...
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 0.4, delay: 1.1 }} // Adjusted delay
        >
          Have an account?{" "}
          <motion.a
            href="/login"
