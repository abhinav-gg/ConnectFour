...
import { Home, LogIn, BarChart2, PlayCircle, Info, Book, Calendar } from 'lucide-react'

export default function Dashboard() {
  return (
    <div className="w-48 bg-white p-4 flex flex-col shadow-md min-h-screen">
      <div className="flex items-center gap-2 mb-6">
      <div className="scale-100 transform-origin-left">
        <img src="/logo.png" alt="Main Logo" className="w-full h-full" />
      </div>
        <h2 className="text-l font-bold text-gray-800">Dashboard</h2>
      </div>
