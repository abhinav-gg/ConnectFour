...
const gameboardColors: CellColor[] = [
  'red', 'empty', 'empty', 'empty', 'yellow', 'empty', 'empty',
  'empty', 'empty', 'empty', 'empty', 'yellow', 'empty', 'empty',
  'red', 'turquoise', 'turquoise', 'turquoise', 'yellow', 'yellow', 'yellow',
  'red', 'turquoise', 'empty', 'empty', 'yellow', 'empty', 'yellow',
  'red', 'turquoise', 'turquoise', 'turquoise', 'yellow', 'empty', 'yellow',
